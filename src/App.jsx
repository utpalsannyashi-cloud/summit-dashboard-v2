...
Be concise and professional.`;
                        ...
                        <table style={{width:'100%',borderCollapse:'collapse',tableLayout:'fixed'}}>
                          <thead>
                            <tr style={{background:t.bg}}>
                              {['Personnel Name','Designation','Move To','Actions'].map((h, i)=>(
  ...
  {o.origin_station&&<div style={{fontSize:11,color:t.muted,marginTop:2}}>📍 {o.origin_station}</div>}
  {o.deployment_duration&&<div style={{fontSize:11,color:t.muted}}>⏱ {o.deployment_duration}</div>}
</td>
